...
const Developerform = ({formdisplay})=>{
    ...
    return (
        ...
        <form onSubmit = {submitHandler}>
            ...
            <input type="text" value={hackerrank} onChange={(e)=>sethackerrank(e.target.value)}></input>
            <label htmlFor="github">LinkedIn</label>
            <input type="text" value={linked} onChange={(e)=>setlinked(e.target.value)}></input>
            <label htmlFor="github">Medium</label>
            <input type="text" value={medium} onChange={(e)=>setmedium(e.target.value)}></input>
            ...
            <input type="text" value={codechef} onChange={(e)=>setcodechef(e.target.value)}></input>
            <div className="btns">
                
                <button id="btn2" onClick={clickHandler}>Exit</button>
